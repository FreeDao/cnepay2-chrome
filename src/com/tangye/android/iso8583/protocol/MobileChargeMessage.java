...
public class MobileChargeMessage extends BaseMessageAbstract{
	...
	public MobileChargeMessage setAmountTotal_4(BigDecimal amount) {
		req.setValue(4, amount, IsoType.AMOUNT);
		return this;
	}
		
    public MobileChargeMessage setCardTracerNumber_11(String traceNumber) {
        req.setValue(11, traceNumber, IsoType.NUMERIC, 6);
        return this;
    }
    
    private MobileChargeMessage setIsPinNeed_22(boolean is) {
    	if(is) {
    ...
    private MobileChargeMessage setMaxPinLength_26(int len) {
    ...
    public MobileChargeMessage setTerminalMark_41(String terminalMark) {
        req.setValue(41, terminalMark, IsoType.ALPHA, 8);
        return this;
    }
    
    public MobileChargeMessage setUserMark_42(String userMark) {
        req.setValue(42, userMark, IsoType.ALPHA, 15);
        return this;
    }
    
    public MobileChargeMessage setUserPin_52(String pin) {
    	req.setValue(52, pin, IsoType.ALPHA, 8); // 加密后的64位Binary,8个字节
    	return this;
    }
  
    private MobileChargeMessage setSecurityControl_53(String sec) {
    ...
    public MobileChargeMessage setSetNumber_60(String setNumber) {
    	String tmp = TraceType_60_1 + setNumber; // setNumber length should be 6
        req.setValue(60, tmp, IsoType.LLLVARBCD);
        return this;
    }
    
    public MobileChargeMessage setUseMac_64() {
        req.setUseMac64(true);
    	return this;
    }
    public MobileChargeMessage setCardInfo(CardInfo ci) {
